...
## Simulation study
##
## Percentage bias nested loop plots
...
# 1 - Naive ----
##############################
png(paste0("./results/figures", "/size_valdata_40_naive.png"),
...
# 2 - Complete case ----
##############################
png(paste0("./results/figures", "/size_valdata_40_cc.png"),
    width = 4, height = 4, units = 'in', res = 500)
create_nlp(summary = summary,
           stats = "perc_bias",
           ref = 0,
...
##############################
png(paste0("./results/figures", "/size_valdata_40_rc.png"),
    width = 4, height = 4, units = 'in', res = 500)
create_nlp(summary = summary,
           stats = "perc_bias",
           ref = 0, 
...
##############################
png(paste0("./results/figures", "/size_valdata_40_erc.png"),
    width = 4, height = 4, units = 'in', res = 500)
create_nlp(summary = summary,
           stats = "perc_bias",
           ref = 0,
...
##############################
png(paste0("./results/figures", "/size_valdata_40_irc.png"),
    width = 4, height = 4, units = 'in', res = 500)
create_nlp(summary = summary,
           stats = "perc_bias",
           ref = 0,
