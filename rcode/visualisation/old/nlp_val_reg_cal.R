...
# 1 - Percentage bias ----
##############################
png(paste0("./results/figures", "/perc_bias_val_reg_cal.png"),
...
# 3 - coverage ----
##############################
png(paste0("./results/figures", "/cover_val_reg_cal.png"),
    width = 4, height = 4, units = 'in', res = 250)
create_nlp(
  summary = summary,
  stats = "cover",
...
# 1 - Percentage bias ----
##############################
png(paste0("./results/figures", "/perc_bias_val_reg_cal_010.png"),
    width = 4, height = 4, units = 'in', res = 250)
create_nlp(
  summary = summary,
  stats = "perc_bias",
  ...
  xlab = "2 x 4 x 3 = 24 ordered scenarios",
  ylab = "percentage bias (%)",
  use_size_valdata = 0.10,
  use_sampling_strats = use_sampling_strats,
  use_method = use_method,
  y_axis_at = c(-25, 0, 10),
  y_axis_labels = c("-25", "0", "10", "")
)
dev.off()
...
# 2 - MSE ----
##############################
pdf(paste0("./results/figures", "/mse_vrc_10.pdf"),
    width = 8, height = 3.5)
create_nlp(
  summary = summary,
  stats = "mse",
...
# 3 - coverage ----
##############################
png(paste0("./results/figures", "/cover_val_reg_cal_010.png"),
    width = 4, height = 4, units = 'in', res = 250)
create_nlp(
  summary = summary,
  stats = "cover",
  ...
  use_sampling_strats = use_sampling_strats,
  use_method = use_method,
  y_axis_at = c(0.6, 0.95, 1),
  y_axis_labels = c("0.6", "0.95", "1", "")
)
dev.off()
